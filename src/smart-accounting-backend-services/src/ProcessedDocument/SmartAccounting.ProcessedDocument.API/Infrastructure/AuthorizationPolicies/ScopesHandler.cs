...
namespace SmartAccounting.ProcessedDocument.API.Infrastructure.AuthorizationPolicies
{
    internal class ScopesHandler : AuthorizationHandler<ScopesRequirement>
    {
